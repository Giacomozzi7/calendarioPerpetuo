        ...
        return (
            <View style={{...styles.container, backgroundColor: colores.containerBack}}>
                ...
                <View style={styles.viewFecha}>
                    ...
                    <DateChanger tipo={'year'} velo={40} date={date} monthsYear={monthsYear} stopTimer={stopTimer} modFecha={modFecha} setDate={setDate}/>  
                </View>
                ...
                <View style={styles.viewDia}>
                    ...
                    date['year'] > 999
                        ? <Text style={{...styles.textoDia, color: colores.textoDia}}>{weekDays[diaSemana]}</Text>
                        : <>
                            <MaterialIcons name="error" size={scale(35)} color={'#ffcc00'} style={{marginBottom:'2%'}} />
                ...
                <View style={styles.viewBoton}>
                    <TouchableOpacity 
                        style={{...styles.touchRes, backgroundColor: colores.botonBack}} 
                        onPress = {resetFecha}>
                            <Text style={styles.textoBoton}>Reestablecer</Text>
                    </TouchableOpacity>
                </View>
